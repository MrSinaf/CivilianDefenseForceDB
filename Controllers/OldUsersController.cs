...
[Authorize, Route("Old")]
public class OldUsersController(MySqlDataSource db) : Controller
{
    ...
    public async Task<IActionResult> Report(string id, string message)
    {
        ...
        cmd.Parameters.AddWithValue("author", User.GetIdStr());
    ...
    public async Task<IActionResult> Create(UserModel model)
    {
        ...
        cmd.Parameters.AddWithValue("corporation", model.corporation);
        cmd.Parameters.AddWithValue("divers", model.divers ?? "");
        cmd.Parameters.AddWithValue("agent", User.GetIdStr());
        await cmd.ExecuteNonQueryAsync();
